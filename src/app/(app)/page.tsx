  ...
  return (
    <div className="min-h-screen bg-white text-black flex flex-col items-center justify-center p-6">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-black mb-4 animate-pulse">
      ...
      >
          ...
          {messages.map((message, index) => (
            <CarouselItem key={index}>
              <Card className="bg-gray-800 text-white">
                ...
                <CardDescription className="text-right p-4 text-white">
        ...
        <div className="flex justify-center mt-4">
          <CarouselPrevious className="mr-4 text-black border-white" />
          <CarouselNext className="text-black border-white" />
        </div>
      </Carousel>
